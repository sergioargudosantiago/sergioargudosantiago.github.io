...
function openModal(type, title, exerciseNumber = null, topicCount = null) {
    if (type === 'coming-soon') {
        // El modal lleva su propio encabezado fijo en el HTML y no tiene ningún
        // #comingSoonTitle; sin el encadenamiento opcional esto lanzaba y los
        // ejercicios 2.º y 4.º no llegaban a abrirse.
...
// Estos modales solo existen en temario.html, pero main.js se carga en todas las
// páginas: sin el encadenamiento opcional, aquí se lanza un TypeError que aborta la
// evaluación del resto del fichero en index, comercio-exterior, enlaces y sobre-mí.
